   ...
   <div class="row">
    ...
    echo '<div class="row">';
          echo'<div class="col-sm-4">
            ...
            echo '<a class="nav-link" href="images.php?q='.$term.'&offset=';
            ...
            for( $i = 0;$i<(10);$i=$i+1)
            {
              ...
              echo '" href="images.php?q='.$term.'&offset='.$salto.'">'.($salto/10+1).'</a>';
              echo '</li>';
            ...
            echo '<a class="nav-link" href="images.php?q='.$term.'&offset='.($offset+10).'"><span class="fas fa-arrow-alt-circle-right"><span/></a>';
            echo '</li>';
